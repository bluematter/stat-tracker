...
; Backbone = global.Backbone = require("C:\\wamp\\www\\BlueMatter\\demo\\client\\requires\\backbone\\js\\backbone.js");
_ = global._ = require("C:\\wamp\\www\\BlueMatter\\demo\\bower_components\\underscore\\underscore.js");
...
; browserify_shim__define__module__export__(typeof Backbone.DualStorage != "undefined" ? Backbone.DualStorage : window.Backbone.DualStorage);

}).call(global, undefined, undefined, undefined, function defineExport(ex) { module.exports = ex; });

},{"C:\\wamp\\www\\BlueMatter\\demo\\bower_components\\underscore\\underscore.js":9,"C:\\wamp\\www\\BlueMatter\\demo\\client\\requires\\backbone\\js\\backbone.js":10}],2:[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
...
; browserify_shim__define__module__export__(typeof Backbone.Nested != "undefined" ? Backbone.Nested : window.Backbone.Nested);

}).call(global, undefined, undefined, undefined, function defineExport(ex) { module.exports = ex; });

},{"C:\\wamp\\www\\BlueMatter\\demo\\bower_components\\underscore\\underscore.js":9,"C:\\wamp\\www\\BlueMatter\\demo\\client\\requires\\backbone\\js\\backbone.js":10}],3:[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {

; Backbone = global.Backbone = require("C:\\wamp\\www\\BlueMatter\\demo\\client\\requires\\backbone\\js\\backbone.js");
Backbone.Wreqr = global.Backbone.Wreqr = require("C:\\wamp\\www\\BlueMatter\\demo\\bower_components\\backbone.marionette\\public\\javascripts\\backbone.wreqr.js");
Backbone.BabySitter = global.Backbone.BabySitter = require("C:\\wamp\\www\\BlueMatter\\demo\\bower_components\\backbone.marionette\\public\\javascripts\\backbone.babysitter.js");
Backbone.Nested = global.Backbone.Nested = require("C:\\wamp\\www\\BlueMatter\\demo\\bower_components\\backbone-nested-model\\backbone-nested.js");
...
},{"C:\\wamp\\www\\BlueMatter\\demo\\bower_components\\backbone-nested-model\\backbone-nested.js":2,"C:\\wamp\\www\\BlueMatter\\demo\\bower_components\\backbone.marionette\\public\\javascripts\\backbone.babysitter.js":4,"C:\\wamp\\www\\BlueMatter\\demo\\bower_components\\backbone.marionette\\public\\javascripts\\backbone.wreqr.js":5,"C:\\wamp\\www\\BlueMatter\\demo\\client\\requires\\backbone\\js\\backbone.js":10}],4:[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
...
},{"C:\\wamp\\www\\BlueMatter\\demo\\client\\requires\\backbone\\js\\backbone.js":10}],5:[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
...
},{"C:\\wamp\\www\\BlueMatter\\demo\\bower_components\\underscore\\underscore.js":9,"C:\\wamp\\www\\BlueMatter\\demo\\client\\requires\\backbone\\js\\backbone.js":10}],6:[function(require,module,exports){
...
; $ = global.$ = require("C:\\wamp\\www\\BlueMatter\\demo\\bower_components\\jquery\\jquery.js");
underscore = global.underscore = require("C:\\wamp\\www\\BlueMatter\\demo\\bower_components\\underscore\\underscore.js");
//     Backbone.js 1.1.0
...
},{"C:\\wamp\\www\\BlueMatter\\demo\\bower_components\\jquery\\jquery.js":7,"C:\\wamp\\www\\BlueMatter\\demo\\bower_components\\underscore\\underscore.js":9,"underscore":9}],11:[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {

; jQuery = global.jQuery = require("C:\\wamp\\www\\BlueMatter\\demo\\bower_components\\jquery\\jquery.js");
/* ========================================================================
...
},{"C:\\wamp\\www\\BlueMatter\\demo\\bower_components\\jquery\\jquery.js":7}],12:[function(require,module,exports){
...
},{"./collections/espn/nbaPlayers":13,"./collections/players":14,"./collections/teams":15,"./controller":16,"./models/player":19,"./models/team":20,"./router":21,"backbone.dualStorage":1,"backbone.marionette":3,"bootstrap":11}],13:[function(require,module,exports){
...
},{"../../models/espn/nbaPlayer":18,"backbone":10}],14:[function(require,module,exports){
var Backbone = require('backbone'),
    PlayerModel = require('../models/player');
...
},{"../models/player":19,"backbone":10}],15:[function(require,module,exports){
var Backbone = require('backbone'),
    TeamModel = require('../models/team'),
...
},{"../models/team":20,"./players":14,"backbone":10}],16:[function(require,module,exports){
var Marionette = require('backbone.marionette'),
...
},{"./views/app":22,"./views/home":26,"backbone.marionette":3}],17:[function(require,module,exports){
var App = require('./app');
var myapp = new App();
myapp.start();
...
},{"backbone":10}],20:[function(require,module,exports){
var Backbone          = require('backbone');
...
},{"../collections/players":14,"backbone":10}],21:[function(require,module,exports){
var Marionette = require('backbone.marionette');
...
},{"backbone.marionette":3}],22:[function(require,module,exports){
var Marionette   = require('backbone.marionette'),
...
},{"../../templates/app.hbs":31,"../collections/teams":15,"./data/teamData":24,"./feed/feed":25,"./leaders/leaders":27,"./settings/setTeams":28,"./teams/teams":30,"backbone.marionette":3,"jquery.stellar":6,"snapjs":8}],23:[function(require,module,exports){
var Marionette = require('backbone.marionette');
...
},{"../../../templates/data/playerData.hbs":32,"backbone.marionette":3}],24:[function(require,module,exports){
var Marionette = require('backbone.marionette'),
...
},{"../../../templates/data/teamData.hbs":33,"./playerData":23,"backbone.marionette":3}],25:[function(require,module,exports){
var Marionette = require('backbone.marionette'),
    PlayersCollection = require('../../collections/players');
...
},{"../../../templates/feed/feed.hbs":34,"../../../templates/feed/feeds.hbs":35,"../../collections/players":14,"backbone.marionette":3}],26:[function(require,module,exports){
var Marionette   = require('backbone.marionette');
...
},{"../../templates/home.hbs":36,"backbone.marionette":3}],27:[function(require,module,exports){
var Marionette = require('backbone.marionette'),
    PlayersCollection = require('../../collections/players');
...
},{"../../../templates/leaders/leaders.hbs":37,"../../../templates/leaders/live-stats.hbs":38,"../../collections/players":14,"backbone.marionette":3}],28:[function(require,module,exports){
var Marionette = require('backbone.marionette');
...
},{"../../../templates/team-list.hbs":39,"backbone.marionette":3}],29:[function(require,module,exports){
var Marionette = require('backbone.marionette');
...
},{"../../../templates/teams/player.hbs":41,"backbone.marionette":3}],30:[function(require,module,exports){
var Marionette = require('backbone.marionette'),
...
},{"../../../templates/teams/basketball.hbs":40,"../../../templates/teams/team.hbs":42,"../../collections/players":14,"./player":29,"backbone.marionette":3}],31:[function(require,module,exports){
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div style=\"color: rgb(255, 255, 255); height: 45px; background-color: rgba(0, 0, 0, 0.7); position: fixed; z-index: 9; width: 100%; left: 0px;\"></div>\r\n\r\n<div id=\"feed-items\">\r\n    \r\n    <div class=\"stellar\" style=\"transform: translate3d(0px, 0px, 0px);\">\r\n		<div class=\"left-box\" style=\"background-color: #393F4F;\">\r\n			<div data-stellar-ratio=\"0.4\" class=\"base\">\r\n				<h1>Tony steals the ball</h1>\r\n				<div style=\"background-image: url(&quot;http://i.cdn.turner.com/nba/nba/.element/img/2.0/sect/statscube/players/large/tony_parker.png&quot;); width: 100%; background-repeat: no-repeat; height: 185px; position: relative;\">\r\n				</div>\r\n			</div>\r\n		</div>\r\n	</div>\r\n	<div class=\"stellar\" style=\"transform: translate3d(0px, 0px, 0px); z-index: -1;\">\r\n		<div class=\"right-box\" style=\"background-color: rgb(255, 48, 19);\">\r\n			<div data-stellar-ratio=\"0.4\" class=\"base\">\r\n				<h1>Derrick Made a Shot</h1>\r\n				<div style=\"background-image: url(&quot;http://i.cdn.turner.com/nba/nba/.element/img/2.0/sect/statscube/players/large/derrick_rose.png&quot;); width: 100%; background-repeat: no-repeat; height: 185px; position: relative;\"></div>\r\n			</div>\r\n		</div>\r\n	</div>\r\n	<div class=\"stellar\" style=\"transform: translate3d(0px, 0px, 0px); z-index: -2;\">\r\n		<div class=\"left-box\" style=\"background-color: #393F4F;\">\r\n			<div data-stellar-ratio=\"0.4\" class=\"base\">\r\n			    <h1>Tony steals the ball</h1>\r\n				<div style=\"background-image: url(&quot;http://i.cdn.turner.com/nba/nba/.element/img/2.0/sect/statscube/players/large/tony_parker.png&quot;); width: 100%; background-repeat: no-repeat; height: 185px; position: relative;\"></div>\r\n			</div>\r\n		</div>\r\n	</div>\r\n	<div class=\"stellar\" style=\"transform: translate3d(0px, 0px, 0px); top: -200px; z-index: -3;\">\r\n		<div class=\"right-box\" style=\"background-color: rgb(255, 48, 19);\">\r\n			<div data-stellar-ratio=\"0.4\" class=\"base\">\r\n				<h1>Derrick Made a Shot</h1>\r\n				<div style=\"background-image: url(&quot;http://i.cdn.turner.com/nba/nba/.element/img/2.0/sect/statscube/players/large/derrick_rose.png&quot;); width: 100%; background-repeat: no-repeat; height: 185px; position: relative;\"></div>\r\n			</div>\r\n		</div>\r\n	</div>\r\n\r\n</div>";
  });
...
},{"hbsfy/runtime":46}],40:[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":46}],41:[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div class=\"player col-xs-12\">\r\n\r\n    <div class=\"col-xs-3 column stat name\">\r\n        <span class=\"column face\" style=\"display: block; overflow: hidden; position: relative; border-radius: 100em; width: 49px; height: 49px; background-color: rgb(227, 227, 227); top: 15px;\">\r\n            <img src=\"http://i.cdn.turner.com/nba/nba/.element/img/2.0/sect/statscube/players/large/";
  if (stack1 = helpers.name_format) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.name_format; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + ".png\" class=\"player-image img-responsive\"/>\r\n        </span> \r\n        <span class=\"column\" style=\"position: absolute; top: 0px; left: 102px;\">\r\n            <span> ";
  if (stack1 = helpers.player_name) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.player_name; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
...
},{"hbsfy/runtime":46}],42:[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":46}],43:[function(require,module,exports){
/*jshint eqnull: true */
...
},{"handlebars/lib/handlebars/base":43,"handlebars/lib/handlebars/runtime":44,"handlebars/lib/handlebars/utils":45}]},{},[17])